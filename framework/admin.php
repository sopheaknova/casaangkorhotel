...
if ( !function_exists( 'optionsframework_init' ) ) {
	...
	define( 'OPTIONS_FRAMEWORK_URL', SP_BASE_DIR . 'framework/admin/' );
	define( 'OPTIONS_FRAMEWORK_DIRECTORY', SP_BASE_URL . 'framework/admin/' );
...
function googleFontPreview( option ){
	...
	if( font !== '' && font !== 'off' && font !== 'none' ){
		...
		alert("<?php _e('No font selected!', 'sp_framework'); ?>");
